  ...
  return (
    <div className="usuarios-permisos-crm">
      ...
      <div className="up-header">
        ...
        <p>
          Controla usuarios, roles, unidades de negocio y acceso por modulo dentro del CRM Central ELANKAV.
          Este modulo deja preparada la base para auditoria, trazabilidad y operacion multiusuario.
        </p>
      </div>
        ...
        <div className="up-panel">
          ...
          <form className="up-form" onSubmit={guardarUsuario}>
            ...
            <div className="up-row">
              ...
              <label>Telefono<input name="telefono" value={usuarioForm.telefono} onChange={cambiarUsuarioForm} /></label>
            </div>
            <div className="up-row">
      ...
      <div className="up-grid">
        <div className="up-panel">
          ...
          <form className="up-form" onSubmit={guardarRol}>
            ...
            <label>Descripcion<textarea name="descripcion" value={rolForm.descripcion} onChange={cambiarRolForm} /></label>
