...
export default function Cobros() {
  ...
  return (
    <div style={styles.page}>
      <div style={styles.header}><h2 style={styles.title}>Cobros</h2><p style={styles.subtitle}>Ventas y cobros con IVA débito, retención y control de ingresos sin factura.</p></div>
      ...
      <form style={styles.card} onSubmit={guardar}>
        <div style={styles.grid}>
          ...
          <label style={styles.label}>Método<select style={styles.select} name="metodoPago" value={form.metodoPago} onChange={cambiar}>{METODOS.map((m) => <option key={m} value={m}>{m}</option>)}</select></label>
