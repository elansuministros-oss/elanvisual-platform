...
export default function CuentasPorCobrar() {
      ...
      if (name === 'cobroId') {
        ...
        if (cobro) {
          nuevo = {
            ...
            facturaFiscal: cobro.facturaFiscal || 'Si',
  ...
  return (
    <div style={styles.page}>
      <div style={styles.header}><h2 style={styles.title}>Cuentas por Cobrar</h2><p style={styles.subtitle}>Control de saldos pendientes con clasificacion fiscal y retenciones.</p></div>
