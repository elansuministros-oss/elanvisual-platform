...
export default function CuentasPorPagar() {
      ...
      if (name === 'compraId') {
        ...
        if (compra) {
          nuevo = {
            ...
            facturaFiscal: compra.facturaFiscal || 'Si',
  ...
  const editar = (item) => {
    ...
    setForm(recalcular({
      ...
      facturaFiscal: item.facturaFiscal || (numero(item.ivaCredito || item.iva) > 0 ? 'Si' : 'No'),
  ...
  return (
    <div style={styles.page}>
      <div style={styles.header}><h2 style={styles.title}>Cuentas por Pagar</h2><p style={styles.subtitle}>Control de proveedores, IVA credito pendiente y pagos sin factura fiscal.</p></div>
      ...
      <form style={styles.card} onSubmit={guardar}>
        <div style={styles.grid}>
          ...
          <label style={styles.label}>Emision<input style={styles.input} type="date" name="fechaEmision" value={form.fechaEmision} onChange={cambiar} /></label>
