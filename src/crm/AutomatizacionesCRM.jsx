...
export default function AutomatizacionesCRM() {
  ...
  const acciones = useMemo(() => [
    ...
    ...produccion.filter(i => ['pendiente','en proceso','activa'].includes((i.estado || '').toLowerCase())).map(i => ({ tipo:'Produccion activa', detalle: i.codigo || i.producto || i.id, prioridad:'Media' })),
  ...
  return <div style={{ padding: 20 }}>
    <h2>Automatizaciones Corporativas</h2><p style={{ color: '#6b7280' }}>Reglas operativas sugeridas por el sistema segun cobros, pagos, ordenes, produccion e inventario.</p>
