...
export default function AutomatizacionesCRM() {
  ...
  const acciones = useMemo(() => [
    ...
    ...produccion.filter(i => ['pendiente','en proceso','activa'].includes((i.estado || '').toLowerCase())).map(i => ({ tipo:'ProducciÃ³n activa', detalle: i.codigo || i.producto || i.id, prioridad:'Media' })),
  ...
  return <div style={{ padding: 20 }}>
    <h2>Automatizaciones Corporativas</h2><p style={{ color: '#6b7280' }}>Reglas operativas sugeridas por el sistema segÃºn cobros, pagos, Ã³rdenes, producciÃ³n e inventario.</p>
