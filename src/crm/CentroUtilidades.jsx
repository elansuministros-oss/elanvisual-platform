  ...
  return (
    <div style={styles.page}>
      ...
      <section style={styles.stats}>
        ...
        <div style={styles.stat}><span style={styles.statLabel}>Costos produccion</span><strong style={styles.statValue}>{moneda(datos.totales.costosProduccion)}</strong></div>
          ...
          <table style={styles.table}>
            <thead>
              <tr>
                ...
                <th style={styles.th}>Costos produccion</th>
