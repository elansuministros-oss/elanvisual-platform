...
export default function CalendarioCorporativo() {
  ...
  const eventos = useMemo(() => [
    ...
    ...produccion.map(i=>({fecha: fechaRegistro(i), tipo:'Producción', titulo:i.codigo || i.producto || i.id, unidad: unidadDe(i)})),
