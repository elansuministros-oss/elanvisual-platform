...
const esConIVA = (item = {}) => item.tipoFiscal === 'Con IVA' || item.facturaFiscal === 'Si' || numero(item.ivaDebito || item.ivaCredito || item.iva) > 0;
  ...
  return (
    <div style={styles.page}>
      <div style={styles.header}>
        <p style={styles.pretitle}>FASE 5.2 - MÃ“DULO FISCAL CORPORATIVO</p>
        <h2 style={styles.title}>Fiscal CRM</h2>
        <p style={styles.subtitle}>
          Control separado entre declaracion fiscal y realidad interna: IVA debito, IVA credito,
          retenciones, facturacion, compras sin factura y utilidad real por unidad de negocio.
        </p>
      </div>
      ...
      <div style={styles.stats}>
        <div style={styles.stat}><span style={styles.statLabel}>IVA debito cobrado</span><strong style={styles.statValue}>{moneda(fiscal.debitoCobros)}</strong><span style={styles.statHelp}>Ventas con IVA registradas en cobros.</span></div>
        <div style={styles.stat}><span style={styles.statLabel}>IVA credito compras</span><strong style={styles.statValue}>{moneda(fiscal.creditoCompras)}</strong><span style={styles.statHelp}>Compras con factura fiscal.</span></div>
        <div style={styles.stat}><span style={styles.statLabel}>IVA neto caja</span><strong style={styles.statValue}>{moneda(fiscal.ivaNetoCaja)}</strong><span style={styles.statHelp}>Debito cobrado menos credito de compras.</span></div>
      ...
      <div style={styles.stats}>
        <div style={styles.stat}><span style={styles.statLabel}>IVA debito pendiente</span><strong style={styles.statValue}>{moneda(fiscal.debitoPendiente)}</strong><span style={styles.statHelp}>CxC con IVA, aun no cobrada total o parcialmente.</span></div>
        <div style={styles.stat}><span style={styles.statLabel}>IVA credito pendiente</span><strong style={styles.statValue}>{moneda(fiscal.creditoPendiente)}</strong><span style={styles.statHelp}>CxP con factura fiscal pendiente.</span></div>
      ...
      <div style={styles.stats}>
        <div style={styles.stat}><span style={styles.statLabel}>Utilidad fiscal estimada</span><strong style={styles.statValue}>{moneda(fiscal.utilidadFiscal)}</strong><span style={styles.statHelp}>Solo operacion con soporte fiscal o exenta.</span></div>
      ...
      <div style={styles.warning}>
        <strong>Nota operativa:</strong> este modulo separa control fiscal y control real interno. Los valores son estimaciones administrativas del CRM; antes de declarar, deben compararse con facturas oficiales, retenciones emitidas por clientes y criterios del contador.
      </div>
          ...
          <table style={styles.table}>
            <thead>
              <tr>
                ...
                <th style={styles.th}>IVA debito</th>
                <th style={styles.th}>IVA credito</th>
      ...
      <div style={styles.card}>
        <h3 style={styles.sectionTitle}>Lectura rapida</h3>
        <p style={styles.sectionText}>
          ...
          La utilidad fiscal excluye movimientos sin factura; la utilidad real interna si los incluye para que el negocio no pierda control de dinero.
        </p>
      </div>
    </div>
  );
