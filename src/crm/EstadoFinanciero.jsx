...
export default function EstadoFinanciero() {
  ...
  const saludFinanciera = (() => {
    ...
    return 'Requiere atención financiera';
  })();
    ...
    <div style={styles.page}>
      ...
      <section style={styles.grid2}>
        <div style={styles.card}>
          ...
          <p style={styles.muted}>Endeudamiento alto indica presión de cuentas por pagar frente a la caja, cobros y cuentas por cobrar.</p>
        </div>
