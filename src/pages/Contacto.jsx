  ...
  return (
    <main>
      <section className="catalog-hero">
        <div><span className="badge">Atencion al cliente</span><h1>Consulta tu pedido o solicita informacion</h1><p>Escribenos para confirmar medidas, disponibilidad, tiempos de entrega o seguimiento de tu pedido.</p></div>
      ...
      <section className="cards admin-grid-3">
        ...
        <article className="kpi"><Phone /><b>Atencion</b><span>Pedidos, catalogo y seguimiento.</span></article>
      </section>
