...
export function productCardHtml({ title, subtitle, price, accent = '#e0b632', type = 'ELANVISUAL', image = '' }) {
  ...
  <article class="card">
    ...
    <div class="body"><small>ELANVISUAL</small><h3>${title}</h3><p>${subtitle}</p><div class="bottom"><div><em>Precio</em><strong>${price}</strong></div><a href="/contacto" target="_top">Cotizar</a></div></div>
  </article>`, `
