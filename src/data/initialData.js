...
export const vendedoresIniciales=[{id:'vend-001',nombre:'Vendedor Principal',codigo:'V001',comision:10,estado:'Activo',whatsapp:'',correo:''}];
export const bannersIniciales=[{id:'ban-001',titulo:'Soluciones visuales para marcas, espacios y negocios.',subtitulo:'Rotulación, impresión digital, fachadas, displays, acrílicos, PVC y proyectos especiales.',boton:'Ver Catálogo',enlace:'/catalogo',estado:'Activo',orden:1,imagen:'https://images.unsplash.com/photo-1497366754035-f200968a6e72?q=80&w=1600'}];
export const bancosIniciales=[{id:'bank-001',banco:'BAC',titular:'ELANVISUAL',numero:'000-000000-000',moneda:'USD',tipoCuenta:'Cuenta corriente',estado:'Activo'}];
...
export const usuariosIniciales=[{id:'u-admin',nombre:'Administrador',correo:'admin@elanvisual.com',password:'admin123',rol:'admin'},{id:'u-vend',nombre:'Vendedor',correo:'vendedor@elanvisual.com',password:'vend123',rol:'vendedor',vendedorId:'vend-001'},{id:'u-prod',nombre:'Producción',correo:'produccion@elanvisual.com',password:'prod123',rol:'produccion'}];
