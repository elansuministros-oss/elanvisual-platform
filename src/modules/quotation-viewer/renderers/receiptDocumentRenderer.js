...
function receiptBrand(quotation = {}) {
  ...
  return {
    ...
    logoUrl: text(brand.logoForLightBackground || brand.logoLightUrl || brand.logoUrl),
...
export function buildReceiptDocument(payment = {}, quotation = {}) {
  ...
  const logo = brand.logoUrl
    ? `<img class="brand-logo" src="${safe(brand.logoUrl)}" alt="${safe(brand.name)}">`
